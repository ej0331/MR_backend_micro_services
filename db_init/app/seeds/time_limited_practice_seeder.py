...
from app.models.time_limited_practice_model import TimeLimitedPracticeModel
from app.models.user_model import UserModel
from app.models.type_model import TypeModel
from .base_seeder import BaseSeeder


class TimeLimitedPracticeSeeder(BaseSeeder):
    def run(self):
        load_dotenv()
        if (os.getenv('ENV') == 'develop'):
            ...
            for _ in range(1000):
                time_limited_test = TimeLimitedPracticeModel(
            ...
            print("time_limited_practices added")
