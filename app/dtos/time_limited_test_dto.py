...
class TimeLimitedTestDto(BaseDto):
    def __init__(self, model: TimeLimitedTestModel):
        self.id = model.id
        self.user = {
            "id": model.user.id,
        ...
        self.level1_incorrect_quantity = (model.level1_total_quantity - model.level1_correct_quantity)
        ...
        self.level2_incorrect_quantity = (model.level2_total_quantity - model.level2_correct_quantity)
        ...
        self.level3_incorrect_quantity = (model.level3_total_quantity - model.level3_correct_quantity)
