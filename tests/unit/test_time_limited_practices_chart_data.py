...
scenarios('../features/unit/time_limited_practices_chart_data.feature')
...
@when(
    parsers.parse(
        '發送 get 請求至後端 endpoint /api/time_limited_practices/chart/users/{id}'),
...
def when_send_get_data_request(client, given_valid_parameters, id):
    ...
    response = client.get(f'/api/time_limited_practices/chart/users/{id}', json=given_valid_parameters,
