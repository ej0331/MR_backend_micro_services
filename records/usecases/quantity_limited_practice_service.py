from repositories.quantity_limited_practice_repo import QuantityLimitedPracticeRepository
...
class QuantityLimitedPracticeService():
    def __init__(self) -> None:
        self.quantity_limited_practice_repo = QuantityLimitedPracticeRepository()

    def get_all_quantity_limited_practices(self):
        quantity_limited_practices, total = self.quantity_limited_practice_repo.get_all_quantity_limited_practices()
    ...
    def get_quantity_limited_practices(self, name=None, class_id_list=None, type_id_list=None, finished_start=None, finished_end=None, page=1, per_page=10):
        quantity_limited_practices, max_page, total, from_index, to_index = self.quantity_limited_practice_repo.get_quantity_limited_practices(
    ...
    def get_quantity_limited_practices_chart_data(self, user_id, finished_start=None, finished_end=None):
        ...
        quantity_limited_practices = self.quantity_limited_practice_repo.get_quantity_limited_practices_chart_data(
    ...
    def insert_quantity_limited_practice(self, user_id, type_id, total_quantity, time):
        result = self.quantity_limited_practice_repo.insert_quantity_limited_practice(
            user_id=user_id,
            type_id=type_id,
    ...
    def update_quantity_limited_practice(self, id, level, total_quantity, time):
        result = self.quantity_limited_practice_repo.update_quantity_limited_practice(
            id=id,
            level=level,
            total_quantity=total_quantity,
            time=time,
