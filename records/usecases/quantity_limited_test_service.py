from repositories.quantity_limited_test_repo import QuantityLimitedTestRepository
...
class QuantityLimitedTestService():
    def __init__(self) -> None:
        self.quantity_limited_test_repo = QuantityLimitedTestRepository()

    def get_all_quantity_limited_tests(self):
        quantity_limited_tests, total = self.quantity_limited_test_repo.get_all_quantity_limited_tests()
    ...
    def get_quantity_limited_tests(self, name=None, class_id_list=None, type_id_list=None, finished_start=None, finished_end=None, page=1, per_page=10):
        quantity_limited_tests, max_page, total, from_index, to_index = self.quantity_limited_test_repo.get_quantity_limited_tests(
    ...
    def get_quantity_limited_tests_chart_data(self, user_id, finished_start=None, finished_end=None):
        ...
        quantity_limited_tests = self.quantity_limited_test_repo.get_quantity_limited_tests_chart_data(
    ...
    def insert_quantity_limited_test(self, user_id, type_id, total_quantity, correct_quantity, time):
        result = self.quantity_limited_test_repo.insert_quantity_limited_test(
            user_id=user_id,
            type_id=type_id,
    ...
    def update_quantity_limited_test(self, id, level, total_quantity, correct_quantity, time):
        result = self.quantity_limited_test_repo.update_quantity_limited_test(
            id=id,
            level=level,
            total_quantity=total_quantity,
            correct_quantity=correct_quantity,
