...
class QuantityLimitedTestModel(BaseModel):
    __tablename__ = 'quantity_limited_tests'
    ...
    type = relationship(TypeModel, backref='quantity_limited_tests')

    def __init__(self, user_id, type_id, level1_correct_quantity, level1_total_quantity, level1_time, finished_at, level2_correct_quantity=None, level2_total_quantity=None, level2_time=None, level3_correct_quantity=None, level3_total_quantity=None, level3_time=None):
