...
class TimeLimitedTestModel(BaseModel):
    __tablename__ = 'time_limited_tests'

    id = Column(Integer, primary_key=True)
    user_id = Column(Integer, ForeignKey('users.id'), nullable=False)
    type_id = Column(Integer, ForeignKey('types.id'), nullable=False)
    level1_correct_quantity = Column(Integer, nullable=False)
    level1_incorrect_quantity = Column(Integer, nullable=False)
    ...
    level2_incorrect_quantity = Column(Integer, nullable=True)
    ...
    level3_incorrect_quantity = Column(Integer, nullable=True)
    ...
    type = relationship(TypeModel, backref='time_limited_tests')

    def __init__(self, user_id, type_id, level1_correct_quantity, level1_incorrect_quantity, level1_total_quantity, level1_time, level1_time_limit, finished_at, level2_correct_quantity=None, level2_incorrect_quantity=None, level2_total_quantity=None, level2_time=None, level2_time_limit=None, level3_correct_quantity=None, level3_incorrect_quantity=None, level3_total_quantity=None, level3_time=None, level3_time_limit=None):
        self.user_id = user_id
        self.type_id = type_id
        self.level1_correct_quantity = level1_correct_quantity
        self.level1_incorrect_quantity = level1_incorrect_quantity
        ...
        self.level2_incorrect_quantity = level2_incorrect_quantity
        ...
        self.level3_incorrect_quantity = level3_incorrect_quantity
